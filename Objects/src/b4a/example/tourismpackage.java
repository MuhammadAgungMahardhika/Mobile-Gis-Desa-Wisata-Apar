...
public class tourismpackage extends Activity implements B4AActivity{
	public static tourismpackage mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.tourismpackage");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (tourismpackage).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.tourismpackage");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.tourismpackage", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (tourismpackage) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (tourismpackage) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        if (!dontPause)
            BA.LogInfo("** Activity (tourismpackage) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
        else
            BA.LogInfo("** Activity (tourismpackage) Pause event (activity is not paused). **");
        if (mostCurrent != null)
...
RDebugUtils.currentModule="tourismpackage";
if (Debug.shouldDelegate(mostCurrent.activityBA, "activity_create", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "activity_create", new Object[] {_firsttime}));}
RDebugUtils.currentLine=4521984;
 //BA.debugLineNum = 4521984;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
RDebugUtils.currentLine=4521987;
 //BA.debugLineNum = 4521987;BA.debugLine="Activity.LoadLayout(\"MainScrollView\")";
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=4521988;
 //BA.debugLineNum = 4521988;BA.debugLine="MainScroll.Panel.LoadLayout(\"Package\")";
mostCurrent._mainscroll.getPanel().LoadLayout("Package",mostCurrent.activityBA);
RDebugUtils.currentLine=4521989;
 //BA.debugLineNum = 4521989;BA.debugLine="WebViewPackage.Height = MainScroll.Height";
mostCurrent._webviewpackage.setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=4521990;
 //BA.debugLineNum = 4521990;BA.debugLine="MainScroll.Panel.Height = MainScroll.Height";
mostCurrent._mainscroll.getPanel().setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=4521991;
 //BA.debugLineNum = 4521991;BA.debugLine="TitleNavbar.Text = \"\"";
mostCurrent._titlenavbar.setText(BA.ObjectToCharSequence(""));
RDebugUtils.currentLine=4521993;
 //BA.debugLineNum = 4521993;BA.debugLine="MyWebViewExtras.addWebChromeClient(WebViewPackage";
...
RDebugUtils.currentLine=4521994;
 //BA.debugLineNum = 4521994;BA.debugLine="WebViewPackage.JavaScriptEnabled = True";
...
RDebugUtils.currentLine=4521995;
 //BA.debugLineNum = 4521995;BA.debugLine="WebViewPackage.LoadUrl(Main.server&\"package\")";
mostCurrent._webviewpackage.LoadUrl(mostCurrent._main._server /*String*/ +"package");
RDebugUtils.currentLine=4521996;
 //BA.debugLineNum = 4521996;BA.debugLine="MyWebViewSettings.setDOMStorageEnabled(WebViewPac";
...
RDebugUtils.currentLine=4718592;
 //BA.debugLineNum = 4718592;BA.debugLine="Private Sub BtnBack_Click";
RDebugUtils.currentLine=4718593;
 //BA.debugLineNum = 4718593;BA.debugLine="Log(\"Going back to previous activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("14718593","Going back to previous activity",0);
