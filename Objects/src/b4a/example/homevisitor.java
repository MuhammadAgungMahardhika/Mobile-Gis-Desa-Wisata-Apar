...
public class homevisitor extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.homevisitor");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.homevisitor");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.homevisitor", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public anywheresoftware.b4a.objects.ButtonWrapper _btnpd = null;
public anywheresoftware.b4a.objects.LabelWrapper _labelpd = null;
public anywheresoftware.b4a.objects.PanelWrapper _panelpd = null;
...
RDebugUtils.currentLine=1376259;
 //BA.debugLineNum = 1376259;BA.debugLine="Activity.LoadLayout(\"Homevisitor\")";
mostCurrent._activity.LoadLayout("Homevisitor",mostCurrent.activityBA);
...
RDebugUtils.currentLine=1441793;
 //BA.debugLineNum = 1441793;BA.debugLine="Log(\"HomeVisitor loaded\")";
anywheresoftware.b4a.keywords.Common.LogImpl("11441793","HomeVisitor loaded",0);
RDebugUtils.currentLine=1441794;
 //BA.debugLineNum = 1441794;BA.debugLine="LabelName.Text = \"Hello, Visitor\"";
mostCurrent._labelname.setText(BA.ObjectToCharSequence("Hello, Visitor"));
RDebugUtils.currentLine=1441795;
 //BA.debugLineNum = 1441795;BA.debugLine="LabelUsername.Text = \"\"";
...
RDebugUtils.currentLine=1703937;
 //BA.debugLineNum = 1703937;BA.debugLine="Log(\"Redirect to Package Activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("11703937","Redirect to Package Activity",0);
RDebugUtils.currentLine=1703938;
 //BA.debugLineNum = 1703938;BA.debugLine="StartActivity(TourismPackage)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._tourismpackage.getObject()));
...
anywheresoftware.b4a.keywords.Common.LogImpl("11638401","Redirect to Main Activity",0);
RDebugUtils.currentLine=1638402;
 //BA.debugLineNum = 1638402;BA.debugLine="Main.manager.SetBoolean(\"is_login\", False)";
...
RDebugUtils.currentLine=1638403;
 //BA.debugLineNum = 1638403;BA.debugLine="Main.manager.SetBoolean(\"visitor\", False)";
...
RDebugUtils.currentLine=1638404;
 //BA.debugLineNum = 1638404;BA.debugLine="Main.manager.SetBoolean(\"user\", False)";
...
RDebugUtils.currentLine=1638405;
 //BA.debugLineNum = 1638405;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
RDebugUtils.currentLine=1638406;
 //BA.debugLineNum = 1638406;BA.debugLine="StartActivity(Main)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._main.getObject()));
RDebugUtils.currentLine=1638407;
 //BA.debugLineNum = 1638407;BA.debugLine="End Sub";
return "";
}
public static String  _btnpd_click() throws Exception{
RDebugUtils.currentModule="homevisitor";
if (Debug.shouldDelegate(mostCurrent.activityBA, "btnpd_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "btnpd_click", null));}
RDebugUtils.currentLine=1769472;
 //BA.debugLineNum = 1769472;BA.debugLine="Private Sub BtnPd_Click";
RDebugUtils.currentLine=1769473;
 //BA.debugLineNum = 1769473;BA.debugLine="Log(\"Redirect to Product Activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("11769473","Redirect to Product Activity",0);
RDebugUtils.currentLine=1769474;
 //BA.debugLineNum = 1769474;BA.debugLine="StartActivity(TourismProduct)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._tourismproduct.getObject()));
...
RDebugUtils.currentLine=1572864;
 //BA.debugLineNum = 1572864;BA.debugLine="Private Sub BtnRG_Click";
RDebugUtils.currentLine=1572865;
 //BA.debugLineNum = 1572865;BA.debugLine="Log(\"Redirect to AtractionMap Activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("11572865","Redirect to AtractionMap Activity",0);
RDebugUtils.currentLine=1572866;
 //BA.debugLineNum = 1572866;BA.debugLine="StartActivity(MapsAt)";
