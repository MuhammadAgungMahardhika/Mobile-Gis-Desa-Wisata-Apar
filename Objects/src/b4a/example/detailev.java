...
public class detailev extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.detailev");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example", "b4a.example.detailev");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.detailev", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (detailev) Create, isFirst = " + isFirst + " **");
...
RDebugUtils.currentLine=1966083;
 //BA.debugLineNum = 1966083;BA.debugLine="Activity.LoadLayout(\"MainScrollView\")";
mostCurrent._activity.LoadLayout("MainScrollView",mostCurrent.activityBA);
RDebugUtils.currentLine=1966084;
 //BA.debugLineNum = 1966084;BA.debugLine="MainScroll.Panel.LoadLayout(\"Detail\")";
mostCurrent._mainscroll.getPanel().LoadLayout("Detail",mostCurrent.activityBA);
RDebugUtils.currentLine=1966085;
 //BA.debugLineNum = 1966085;BA.debugLine="wvDetail.Height = MainScroll.Height";
mostCurrent._wvdetail.setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=1966086;
 //BA.debugLineNum = 1966086;BA.debugLine="MainScroll.Panel.Height = MainScroll.Height";
mostCurrent._mainscroll.getPanel().setHeight(mostCurrent._mainscroll.getHeight());
RDebugUtils.currentLine=1966087;
 //BA.debugLineNum = 1966087;BA.debugLine="TitleNavbar.Text = Starter.selectedObj.Get(\"name\"";
...
RDebugUtils.currentLine=1966089;
 //BA.debugLineNum = 1966089;BA.debugLine="MyWebViewExtras.addWebChromeClient(wvDetail, \"wvD";
...
RDebugUtils.currentLine=1966090;
 //BA.debugLineNum = 1966090;BA.debugLine="wvDetail.JavaScriptEnabled = True";
mostCurrent._wvdetail.setJavaScriptEnabled(anywheresoftware.b4a.keywords.Common.True);
RDebugUtils.currentLine=1966091;
 //BA.debugLineNum = 1966091;BA.debugLine="wvDetail.LoadUrl(Main.server&\"detail_event/\"&Star";
mostCurrent._wvdetail.LoadUrl(mostCurrent._main._server /*String*/ +"detail_event/"+BA.ObjectToString(mostCurrent._starter._selectedobj /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)("id"))));
RDebugUtils.currentLine=1966092;
 //BA.debugLineNum = 1966092;BA.debugLine="MyWebViewSettings.setDOMStorageEnabled(wvDetail,T";
...
RDebugUtils.currentLine=2031617;
 //BA.debugLineNum = 2031617;BA.debugLine="Log(\"DetailEv loaded\")";
anywheresoftware.b4a.keywords.Common.LogImpl("12031617","DetailEv loaded",0);
...
RDebugUtils.currentLine=2162688;
 //BA.debugLineNum = 2162688;BA.debugLine="Private Sub BtnBack_Click";
RDebugUtils.currentLine=2162689;
 //BA.debugLineNum = 2162689;BA.debugLine="Log(\"Going back to previous activity\")";
anywheresoftware.b4a.keywords.Common.LogImpl("12162689","Going back to previous activity",0);
