...
try {
		Debug.PushSubsStack("Append (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("Append2 (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("ChangeLength (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,12);
...
try {
		Debug.PushSubsStack("Clear (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("getBuffer (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,103);
...
try {
		Debug.PushSubsStack("getInternalBuffer (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("getLength (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("IndexOf (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("IndexOf2 (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,112);
...
try {
		Debug.PushSubsStack("Initialize (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,6);
...
try {
		Debug.PushSubsStack("Insert (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,43);
...
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","914680066",RemoteObject.createImmutable("Index too large"),0);};
...
try {
		Debug.PushSubsStack("Remove (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,69);
...
try {
		Debug.PushSubsStack("Set (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,56);
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(">",_index,BA.numberCast(double.class, __ref.getField(true,"_mlength" /*RemoteObject*/ )))) { 
b4xbytesbuilder.__c.runVoidMethod ("LogImpl","914745602",RemoteObject.createImmutable("Index too large"),0);};
...
try {
		Debug.PushSubsStack("SubArray (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("SubArray2 (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("ToArray (b4xbytesbuilder) ","b4xbytesbuilder",20,__ref.getField(false, "ba"),__ref,97);
