...
public class detailev implements IRemote{
    ...
    static {
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("detailev"), "b4a.example.detailev");
	}
...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",detailev.mostCurrent._activity,"B4XCollections",Debug.moduleToString(b4a.example.b4xcollections.class),"BtnBack",detailev.mostCurrent._btnback,"Core",Debug.moduleToString(b4a.example.core.class),"DateUtils",detailev.mostCurrent._dateutils,"DetailAt",Debug.moduleToString(b4a.example.detailat.class),"Homeuser",Debug.moduleToString(b4a.example.homeuser.class),"Homevisitor",Debug.moduleToString(b4a.example.homevisitor.class),"HttpUtils2Service",Debug.moduleToString(b4a.example.httputils2service.class),"ListAt",Debug.moduleToString(b4a.example.listat.class),"ListEv",Debug.moduleToString(b4a.example.listev.class),"Main",Debug.moduleToString(b4a.example.main.class),"MainScroll",detailev.mostCurrent._mainscroll,"MapsAt",Debug.moduleToString(b4a.example.mapsat.class),"MapsEv",Debug.moduleToString(b4a.example.mapsev.class),"MyWebViewExtras",detailev.mostCurrent._mywebviewextras,"MyWebViewSettings",detailev.mostCurrent._mywebviewsettings,"Navbar",detailev.mostCurrent._navbar,"Starter",Debug.moduleToString(b4a.example.starter.class),"TitleNavbar",detailev.mostCurrent._titlenavbar,"TourismPackage",Debug.moduleToString(b4a.example.tourismpackage.class),"TourismProduct",Debug.moduleToString(b4a.example.tourismproduct.class),"wvDetail",detailev.mostCurrent._wvdetail,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}