...
try {
		Debug.PushSubsStack("btnMonth_Click (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,160);
...
try {
		Debug.PushSubsStack("btnYear_Click (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,154);
...
try {
		Debug.PushSubsStack("DaysPaneFg_Touch (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,167);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,193);
...
try {
		Debug.PushSubsStack("DrawBox (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,91);
...
try {
		Debug.PushSubsStack("DrawDays (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,62);
...
try {
		Debug.PushSubsStack("getDate (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("GetPanel (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,172);
...
try {
		Debug.PushSubsStack("HandleMouse (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,123);
...
try {
		Debug.PushSubsStack("Hide (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,149);
...
try {
		Debug.PushSubsStack("Initialize (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("SelectDay (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("setDate (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("SetYearsButtonState (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,86);
...
try {
		Debug.PushSubsStack("Show (b4xdatetemplate) ","b4xdatetemplate",31,__ref.getField(false, "ba"),__ref,176);
