...
try {
		Debug.PushSubsStack("Background_Click (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,255);
...
try {
		Debug.PushSubsStack("Background_Touch (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,250);
...
try {
		Debug.PushSubsStack("Blur (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,284);
...
Debug.JustUpdateDeviceLine();
b4xdialog.__c.runVoidMethod ("LogImpl","925100324",RemoteObject.concat(RemoteObject.createImmutable("Time: "),(RemoteObject.solve(new RemoteObject[] {b4xdialog.__c.getField(false,"DateTime").runMethod(true,"getNow"),_n}, "-",1, 2))),0);
...
try {
		Debug.PushSubsStack("Button_Click (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,230);
...
try {
		Debug.PushSubsStack("Close (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,236);
...
try {
		Debug.PushSubsStack("CreateButton (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,190);
...
try {
		Debug.PushSubsStack("GetButton (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,212);
...
try {
		Debug.PushSubsStack("getVisible (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,186);
...
try {
		Debug.PushSubsStack("Initialize (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("InternalAddStubToCLVIfNeeded (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,342);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,338);
...
try {
		Debug.PushSubsStack("Resize (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,260);
...
try {
		Debug.PushSubsStack("SetAvg (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,324);
...
try {
		Debug.PushSubsStack("SetButtonState (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,220);
...
try {
		Debug.PushSubsStack("Show (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,71);
...
_lbl.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 80;BA.debugLine="lbl.SingleLine = False";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ShowCustom (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("ShowTemplate (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,62);
...
try {
		Debug.PushSubsStack("Stub_Click (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,348);
...
try {
		Debug.PushSubsStack("UpdateBlur (b4xdialog) ","b4xdialog",32,__ref.getField(false, "ba"),__ref,271);
