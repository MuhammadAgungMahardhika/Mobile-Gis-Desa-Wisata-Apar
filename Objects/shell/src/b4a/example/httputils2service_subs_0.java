...
try {
		Debug.PushSubsStack("CompleteJob (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,142);
...
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","18585222",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service: job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("hc_ResponseError (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,109);
...
Debug.ShouldStop(131072);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","18519685",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseError): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("hc_ResponseSuccess (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,86);
...
Debug.ShouldStop(16777216);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","18388611",RemoteObject.concat(RemoteObject.createImmutable("HttpUtils2Service (hc_ResponseSuccess): job completed multiple times - "),_taskid),0);
...
try {
		Debug.PushSubsStack("Response_StreamFinish (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,101);
...
try {
		Debug.PushSubsStack("Service_Create (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,27);
...
Debug.ShouldStop(2);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","18126471",BA.ObjectToString(httputils2service.mostCurrent.__c.runMethod(false,"LastException",httputils2service.processBA)),0);
 BA.debugLineNum = 35;BA.debugLine="Log(\"Switching to File.DirInternal\")";
Debug.ShouldStop(4);
httputils2service.mostCurrent.__c.runVoidMethod ("LogImpl","18126472",RemoteObject.createImmutable("Switching to File.DirInternal"),0);
...
try {
		Debug.PushSubsStack("Service_Destroy (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,62);
...
try {
		Debug.PushSubsStack("Service_Start (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,58);
...
try {
		Debug.PushSubsStack("SubmitJob (httputils2service) ","httputils2service",13,httputils2service.processBA,httputils2service.mostCurrent,68);
