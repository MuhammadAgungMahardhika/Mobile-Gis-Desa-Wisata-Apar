...
try {
		Debug.PushSubsStack("AddFormatData (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("CopyFormatData (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("CreateDefaultFormat (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("Format (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,90);
...
try {
		Debug.PushSubsStack("FormatLabel (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,148);
...
try {
		Debug.PushSubsStack("GetDefaultFormat (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("GetFormatData (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,81);
...
try {
		Debug.PushSubsStack("Initialize (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("NewFormatData (b4xformatter) ","b4xformatter",47,__ref.getField(false, "ba"),__ref,30);
