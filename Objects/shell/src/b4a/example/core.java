...
public boolean isSingleton() {
    ...
    static {
        ...
        remoteMe = RemoteObject.declareNull("b4a.example.core");
        anywheresoftware.b4a.pc.RapidSub.moduleToObject.put(new B4XClass("core"), "b4a.example.core");
        RDebug.INSTANCE.eventTargets.put(new DeviceClass("b4a.example.core"), new java.lang.ref.WeakReference<PCBA> (pcBA));
	}
